		...
		if (usuario != null) {
			...
			if ((titulo.isEmpty() || titulo.equals("") || titulo.equals(" ") || titulo.isBlank())) {
				RequestDispatcher dispatcher = request
						.getRequestDispatcher("/WEB-INF/view/tarefa_cadastro_falha_titulo.jsp");
				dispatcher.forward(request, response);
			} else if ((data_conclusao.isEmpty() || data_conclusao.equals("") || data_conclusao.equals(" ")
					|| data_conclusao.isBlank())) {
				RequestDispatcher dispatcher = request
						.getRequestDispatcher("/WEB-INF/view/tarefa_cadastro_falha_data.jsp");
				dispatcher.forward(request, response);
			} else {
				Tarefa t = new Tarefa();
